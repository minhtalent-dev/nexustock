...
* cycle_count_stock_adjustment.read
* cycle_count_stock_adjustment.create
* cycle_count_stock_adjustment.update
* cycle_count_stock_adjustment.approve
* cycle_count_stock_adjustment.export
