...
| 46A | [Secure Attachment Content + Preview](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46a_secure_attachment_content_preview.md) | Auth content API · sửa `/uploads` 404 · preview/download · pending cleanup · QC compat. **✅ Done (`rp4` + `rp5`, 2026-07-24)**. |
