...
| 37 | [Go-Live L3 Customer Pilot](file:///d:/1_Project/48_Nexustock/planning/phases/phase_37_golive_l3_customer_pilot.md) | UAT · cutover · hypercare. **✅ Module DoD 100%** · `PILOT_READY_ACCEPTED_CONDITIONAL` (FOUNDER ký PASS* 2026-08-02). |
...
| 43 | [Core Ops Attach + Master Spreadsheet](file:///d:/1_Project/48_Nexustock/planning/phases/phase_43_ops_attachments_spreadsheet.md) | Master IE 4 · Attach core · Ops export 4 · QC panel. **✅ 100% Ready** (`rp1`+`rp2` F01–F36 · critic **9.5**). |
...
| 46 | [Attachment Experience + Ops Spreadsheet Completion](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46_attachment_experience_ops_spreadsheet_completion.md) | Umbrella P43–P45 · P46A–P46D Done · P46E non-hardware done; camera hardware deferred. |
...
| 46B | [Thumbnail + Full Attachment Coverage](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46b_thumbnail_full_attachment_coverage.md) | Thumbnail lifecycle · đủ 12 attachment types · 6 extended UI contexts. **✅ ĐÓNG** (`rp4` + `rp5` · Module DoD 100% · 2026-07-27). |
| 46C | [Master Spreadsheet + Full Ops Exports](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46c_master_spreadsheet_full_ops_exports.md) | Master IE 4 regression · đủ 12 Ops exports CSV/XLSX. **✅ ĐÓNG** (`rp4` + `rp5` · strict verifier · 76/76 tests · 2026-07-28). |
| 46D | [Package + Operational Line Imports](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46d_package_operational_line_imports.md) | Package IE · Inbound ASN · Stocktake count · idempotent batch. **✅ ĐÓNG** (`rp4` + `rp5` · strict verifier · tái xác minh 85/85 tests · 2026-07-31). |
| 46E | [RF Camera + Full Acceptance](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46e_rf_full_acceptance.md) | **🔄 In Progress** · tái xác minh 2026-07-31 đạt 11/11 automated PASS, typecheck/lint sạch · camera hardware `Deferred Manual Acceptance`; không camera PASS/15-of-15 claim. |
...
| 37 | Go-Live L3 Customer Pilot | ✅ Hoàn thành | **Module DoD 100%** · `PILOT_READY_ACCEPTED_CONDITIONAL` (`rp4`+`rp5` 2026-07-22; FOUNDER ký PASS* 2026-08-02). verify_l3 **12/0**; dbm **21/0**; disk FAIL=0. | 2026-07-22 | [phase_37 §25–§26](file:///d:/1_Project/48_Nexustock/planning/phases/phase_37_golive_l3_customer_pilot.md) · [rp45](file:///d:/1_Project/48_Nexustock/planning/evidence/phase_37_rp45/validation_pass.md) |
...
| 43 | Core Ops Attach + Master Spreadsheet | ✅ Hoàn thành | **`rp4`+`rp5` Module DoD 100%** 2026-07-24. verify PASS 100%; dbm OK; nhập Excel UOMs và đính kèm tài liệu thành công. | 2026-07-24 | [phase_43 §22–§23](file:///d:/1_Project/48_Nexustock/planning/phases/phase_43_ops_attachments_spreadsheet.md) · [dbm](file:///C:/Users/mes/.gemini/antigravity-ide/brain/2c3e71b3-d48d-4fc5-9298-21ad1754f3fd/walkthrough.md) |
...
| 46 | Attachment Experience + Ops Spreadsheet Completion | 🔄 Đang thực hiện | P46A–P46D Done; P46E toàn bộ non-hardware acceptance hoàn tất; strict verifier 11/11 PASS. | — | Camera capture/metadata/permission-denied `Deferred Manual Acceptance`; umbrella chưa đóng. |
...
| 46B | Thumbnail + Full Attachment Coverage | ✅ Hoàn thành | Remediation `rp4` + `rp5` PASS: WebP/log redaction/backfill race-safe; PostgreSQL strict 2/2, Files 10/10, MasterData 33/33, static/frontend gates và browser evidence đầy đủ. | 2026-07-27 | [phase_46b](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46b_thumbnail_full_attachment_coverage.md) · [walkthrough](file:///d:/1_Project/48_Nexustock/planning/evidence/phase_46_dbm/walkthrough.md) |
| 46C | Master Spreadsheet + Full Ops Exports | ✅ Hoàn thành | Master IE 4 roundtrip · Ops exports 12×2 · tenant isolation · cap 5.000 · formula protection · strict verifier và 76/76 integration tests PASS. | 2026-07-28 | [phase_46c](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46c_master_spreadsheet_full_ops_exports.md) · [walkthrough](file:///C:/Users/mes/.gemini/antigravity-ide/brain/1267c81d-0c4e-4711-94e6-b361e1c233a4/walkthrough.md) |
| 46D | Package + Operational Line Imports | ✅ Hoàn thành | Package IE · Inbound ASN line import · Stocktake count import · batch TTL/ownership/concurrency/idempotency · tái nghiệm thu strict verifier và 85/85 integration tests PASS. | 2026-07-31 | [phase_46d](file:///d:/1_Project/48_Nexustock/planning/phases/phase_46d_package_operational_line_imports.md) · [dbm](file:///d:/1_Project/48_Nexustock/planning/evidence/phase_46d_dbm/evidence.md) |
| 46E | RF Camera + Full Acceptance | 🔄 Đang thực hiện | Non-hardware acceptance tái xác minh 2026-07-31: 11/11 automated PASS; P43/P44 100%; file fallback/DOM/evidence contract hoàn tất; typecheck/lint sạch. | — | [acceptance](file:///d:/1_Project/48_Nexustock/planning/evidence/phase_46_dbm/acceptance_matrix.md) · camera hardware deferred, chưa tuyên bố PASS/15-of-15. |
...
| Trước Phase 37 | L3 pilot UAT/cutover pack | ✅ Phase 37 **Module DoD 100%** (`rp4`+`rp5` 2026-07-22) · `PILOT_READY_ACCEPTED_CONDITIONAL` | disk FAIL=0; verify_l3 12/0; dbm 21/0; FOUNDER ký PASS* 2026-08-02. |
...
| Trước Phase 45 | Line/RF/Package/Thumb | Scope P45 đã superseded bởi P46; phần thumbnail tại P46B **✅ ĐÓNG** (`rp4` + `rp5` 2026-07-27) | P46B Module DoD 100%; line/RF/Package theo P46D/P46E |
