...
| 20 | Local Agent foundation | ⬜ Chưa bắt đầu | Đã nâng đặc tả lên 96% execution-ready: khóa decision lock cho Origin Allowlist, port 9000-9005, DPAPI LocalMachine, Pairing Code TTL 3 phút, certificate trust; bổ sung WebSocket protocol envelope, local config contract, startup lifecycle, error code contract, observability và rollback protocol | — | Sẵn sàng bắt đầu theo contract Phase 20; không đổi envelope sau khi Phase 21/22 phụ thuộc nếu không có versioning plan |
