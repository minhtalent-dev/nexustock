...
| 08 | Cycle count & stock adjustment | ✅ Hoàn thành | Hoàn tất thực thể backend Stocktake/Adjustment, migrations PostgreSQL, seed permissions, API kiểm kê/khóa kệ/phê duyệt chênh lệch L1-L3, giao diện Next.js quản lý và thực hiện kiểm kê, integration test pass 100% | 2026-07-13 | — |
