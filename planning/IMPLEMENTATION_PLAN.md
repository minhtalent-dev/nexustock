...
| 14 | Replenishment | 🔄 Đang thực hiện | Thiết lập quy trình bổ sung pick face tự động theo min/max: DDL bảng ReplenishmentRules/Tasks, API camelCase, thuật toán chọn nguồn tối ưu và tích hợp vào MobileTasks handheld | 2026-07-14 | Đã nâng cấp tài liệu đặc tả đạt 95% sẵn sàng thực thi |
